...
<%@page import="com.lmiky.jdp.util.BundleUtils"%>
<%@page import="com.lmiky.jdp.web.constants.Constants"%>
<%
	SessionInfo sessionInfo = WebUtils.getSessionInfo(request);
	if(sessionInfo == null) {
		response.sendRedirect(request.getContextPath() + BundleUtils.getStringValue(Constants.PROPERTIES_KEY_WEB_FILE, "system.loginUrl"));
	} else {
